...
void writeQuotedString(std::ostream& os, const std::string& str, bool forceQuotes = true);
...
template <>
inline void writeGenericValue(std::ostream& os, const std::string& value, bool forceQuotes) {
